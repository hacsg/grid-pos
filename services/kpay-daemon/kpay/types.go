...
type QueryData struct{ OutTradeNO string `json:"outTradeNO"`; TransactionNo string `json:"transactionNo"`; RefNo string `json:"refNo,omitempty"`; PayAmount string `json:"payAmount"`; PayCurrency string `json:"payCurrency"`; PayMethod int `json:"payMethod"`; TransactionType int `json:"transactionType"`; PayResult int `json:"payResult"`; Reason string `json:"reason,omitempty"` }
